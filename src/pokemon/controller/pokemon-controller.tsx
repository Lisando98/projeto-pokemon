    ...
    getPokemonByPromise(promisedPokemon: Promise<any>){
        ...
        .then(async data => {
            if (data.id !== undefined){
                ...
                const pokemonEntity = new PokemonEntity (data.id, data.name, this.getPokemonTypes(data),
                await fetchPokemonLocation(data.location_area_encounters), this.getPokemonAbilities(data), data.base_experience,'');
